...
<p align="center">
  ...
  <a href="https://zerotooneblog.hashnode.dev"><img src="https://img.shields.io/badge/Hashnode-2962FF?style=for-the-badge&logo=hashnode&logoColor=white" /></a>
</p>
...
<table width="100%" bordercolor="#30363d">
  <tr>
    <td width="55%" valign="top">
      <h3><a href="https://github.com/Abhics8/Ticket-Blitz">🎟️ Ticket-Blitz</a> — Distributed Booking Engine</h3>
      <p>Seat booking system with <b>three independent correctness layers</b> (Redis distributed lock + Postgres version-column CAS + UNIQUE constraint) that make an oversell impossible even under partial failure. Includes transactional outbox → idempotent Kafka, virtual FIFO waiting room, token-bucket rate limiter, and a k6 race test that <b>proves zero oversell</b> under 2,000 concurrent requests. Full observability: OpenTelemetry → Jaeger, Prometheus → Grafana.</p>
      <p>
      ...
      <blockquote><p><b>🚀 Live Demo + System Design Doc</b><br><a href="https://ticket-blitz.vercel.app/">ticket-blitz.vercel.app →</a></p></blockquote>
    </td>
    <td width="45%" valign="top">
      <br>
...
<table width="100%" bordercolor="#30363d">
  ...
  <tr>
    <td width="26%" valign="middle"><h4>🌐 Frontend</h4></td>
    <td width="74%" valign="middle">
      <img src="https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB" /> <img src="https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white" /> <img src="https://img.shields.io/badge/Tailwind-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white" />
    </td>
  </tr>
</table>
...
<p align="center">
  <a href="https://zerotooneblog.hashnode.dev">
    <img src="https://img.shields.io/badge/Read_More_on_Hashnode-2962FF?style=for-the-badge&logo=hashnode&logoColor=white" />
  </a>
</p>
